...
if (!checkAdminPermission()) {
    ...
    include('protect_adm.php'); // Crie um arquivo acesso_negado.php com o HTML de erro
...
if (isset($_GET['search'])) {
    ...
    $search_term = $mysqli->real_escape_string($search_term); // Previne SQL injection
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) { // Verifica se há resultados
            while($user_data = mysqli_fetch_assoc($result)) {
                ...
                echo "<td> <a href='editar.php?id=$user_data[id]'><img width='50' height='50' src='https://img.icons8.com/?size=100&id=41647&format=png&color=000000' alt='Editar'></a></td>";
                echo "<td><a href='delete.php?id=$user_data[id]'><img width='50' height='50' src='https://img.icons8.com/?size=100&id=OZuepOQd0omj&format=png&color=000000' alt='Excluir'></a></td>";
                echo "</tr>";
            }
        } else {
